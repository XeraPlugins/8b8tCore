...
public class TPAToggleCommand implements CommandExecutor {
    ...
    @Override
    public boolean onCommand(public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, @NotNull String[] args)){
